        ...
        sm.setSource(new MethodSource() {
            public Body getBody(SootMethod m, String phaseName) {
                ...
                //FLANKER ADD
                    ...
                    String msg = "Warning: jimple failed to transform "+ m +": "+ e;
                    G.v().out.println(msg);
                    Util.emptyBody(b);
                    Util.addExceptionAfterUnit(b, "java.lang.RuntimeException", b.getUnits().getLast(), "Soot has detected that this method contains invalid bytecode which jimple cannot represent. ["+ msg +"]");
                    TypeAssigner.v().transform(b);
                }
                m.setActiveBody(b);
